                                                ...
                                                <table className="table ">
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList?(DataList.map((item,i)=>
                                                            <tr key={i}>
                                                                <td><p className="text-xs text-start">{item.Name}</p>
                                                                </td>
                                                                <td><p className="text-xs text-start">{item.Unit}</p>
                                                                </td>
                                                                <td><p
                                                                    className="text-xs text-start">{Array.isArray(item.Brand) && item.Brand[0] ? item.Brand[0].Name : ""}</p>
                                                                </td>
                                                                <td><p
                                                                    className="text-xs text-start">{Array.isArray(item.Category) && item.Category[0] ? item.Category[0].Name : ""}</p>
                                                                </td>

                                                                <td><p className="text-xs text-start">{item.Details}</p>
                                                                </td>
                                                                <td>
                                                                    <Link to={`/ProductCreateUpdatePage?id=${item._id}`}
