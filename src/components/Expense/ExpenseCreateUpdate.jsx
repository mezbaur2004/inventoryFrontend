                        ...
                        <div className="card-body">
                            <div className="row">
                                ...
                                <div className="col-4 p-2">
                                    ...
                                    <input onChange={(e)=>{store.dispatch(OnChangeExpenseInput({Name:"Notes",Value:e.target.value}))}} value={FormValue.Notes} className="form-control form-control-sm" type="text"/>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-4 p-2">
